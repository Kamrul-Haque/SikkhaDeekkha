...
@section('content')
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Instructor {{ __('Login') }}</div>
                        ...
                        <form method="POST" action="{{ route('instructor.login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    ...
                                    <span class="float-right"><a href="{{ route('instructor.password.request') }}" class="text-custom">Forgot Your Password?</a></span>
                                </div>
                            </div>
                        </form>
                    </div>
